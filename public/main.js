...
var author$project$Board$gridSize = 3;
...
var author$project$Board$initGrid = A2(elm$core$List$range, 1, author$project$Board$gridSize * author$project$Board$gridSize);
var author$project$Player$Unclaimed = {$: 'Unclaimed'};
...
var author$project$Board$initBoard = A3(
	...
	F2(
		function (keyIndex, valueDict) {
			return A3(elm$core$Dict$insert, keyIndex, author$project$Player$Unclaimed, valueDict);
		}),
	elm$core$Dict$empty,
...
var author$project$Board$availableMoves = function (board) {
	return A2(
		...
		function (index) {
			return _Utils_eq(
				A2(elm$core$Dict$get, index, board),
				elm$core$Maybe$Just(author$project$Player$Unclaimed));
		},
		elm$core$Dict$keys(board));
};
...
var author$project$Board$isValidMove = F2(
					...
					A2(
						...
						function (index) {
							return A2(
								...
								author$project$Player$Unclaimed,
								A2(
									elm$core$Array$get,
									index,
...
var author$project$Board$winningLines = _List_fromArray(
	[
		_List_fromArray(
		[0, 1, 2]),
		_List_fromArray(
...
var author$project$Board$isFull = function (board) {
	return A2(
		elm$core$List$all,
		function (x) {
			return !_Utils_eq(x, author$project$Player$Unclaimed);
		},
		elm$core$Dict$values(board));
};
					...
					[
						...
						_List_fromArray(
							[
								...
								author$project$Main$TakeTurn(1))
							]),
						_List_fromArray(
							[
								elm$html$Html$text(
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(
								author$project$Main$TakeTurn(2))
							]),
						_List_fromArray(
							[
								elm$html$Html$text(
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(
								author$project$Main$TakeTurn(3))
							]),
						_List_fromArray(
							[
								elm$html$Html$text(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(
								author$project$Main$TakeTurn(4))
							]),
						_List_fromArray(
							[
								elm$html$Html$text(
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(
								author$project$Main$TakeTurn(5))
							]),
						_List_fromArray(
							[
								elm$html$Html$text(
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(
								author$project$Main$TakeTurn(6))
							]),
						_List_fromArray(
							[
								elm$html$Html$text(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(
								author$project$Main$TakeTurn(7))
							]),
						_List_fromArray(
							[
								elm$html$Html$text(
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(
								author$project$Main$TakeTurn(8))
							]),
						_List_fromArray(
							[
								elm$html$Html$text(
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(
								author$project$Main$TakeTurn(9))
							]),
						_List_fromArray(
							[
								elm$html$Html$text(
...
var author$project$Main$viewBoard = function (grid) {
	return author$project$Main$formatCells(
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						A2(author$project$Main$buttonNewGame, '2 Player', author$project$Main$HumanVsHuman),
						A2(author$project$Main$buttonNewGame, '1 Player (Easy)', author$project$Main$HumanVsEasyComputer)
					]));
		}
	}();
	return A2(
	...
	var welcomeMessage = function () {
		...
		switch (_n0.$) {
			...
			case 'Drawn':
				return elm$html$Html$text('');
			default:
				return elm$html$Html$text('Welcome To Tic Tac Toe');
		}
	}();
	return A2(
		elm$html$Html$h1,
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"HumanVsHuman":[],"HumanVsEasyComputer":[],"TakeTurn":["Basics.Int"],"ResetGame":[],"NoOp":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));